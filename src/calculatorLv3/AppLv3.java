...
public class AppLv3 {
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            while (true) {
                try {
                    System.out.print("첫 번째 숫자(0 이상의 실수)를 입력하세요: ");
                    num1 = sc.nextDouble();
                    if (num1 < 0) {
                        System.out.println("음의 실수는 입력 불가능 합니다!");
                    } else {
                        break;
                    }
            ...
            while (true) {
                try {
                    System.out.print("두 번째 숫자(0 이상의 실수)를 입력하세요: ");
                    num2 = sc.nextDouble();
                    if (num2 < 0) {
                        System.out.println("음의 실수는 입력 불가능 합니다!");
                    } else {
            ...
            // getter 활용
            List<Double> originResults = new ArrayList<>(calculator.getResults());
            ...
            List<Double> biggerResults = calculator.getResultsBigger(threshold);
            System.out.println("[기준값보다 큰 결과 리스트]\n" + biggerResults);
